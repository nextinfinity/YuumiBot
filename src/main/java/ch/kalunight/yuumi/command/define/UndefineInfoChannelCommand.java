...
public class UndefineInfoChannelCommand extends YuumiCommand {
	...
	protected void executeCommand(CommandEvent event) throws SQLException {
		...
		if(infochannel == null) {
			...
			TextChannel channel = Yuumi.getJda().getGuildById(server.serv_guildId).getTextChannelById(infochannel.infochannel_channelid);
